        ...
        for (int i = 0; i < items.size(); i++) {
            ...
            if (!"Aged Brie".equals(itemName) && !"Backstage passes to a TAFKAL80ETC concert".equals(itemName)) {
                ...
                if (currentItem.getQuality() < 50) {
                    ...
                    if (currentItem.getSellIn() < 11 && currentItem.getQuality() < 50) {
                        currentItem.setQuality(currentItem.getQuality() + 1);
                    }

                    if (currentItem.getSellIn() < 6 && currentItem.getQuality() < 50) {
                        currentItem.setQuality(currentItem.getQuality() + 1);
                    }
                }
            }
            ...
            if (currentItem.getSellIn() < 0) {
                if (!"Aged Brie".equals(itemName) && !"Backstage passes to a TAFKAL80ETC concert".equals(itemName) && !"Sulfuras, Hand of Ragnaros".equals(itemName)) {
                    if (currentItem.getQuality() > 0) {
                        currentItem.setQuality(currentItem.getQuality() - 1);
                    }
                } else if ("Aged Brie".equals(itemName)) {
...
/* ORIGINAL CODEpackage fi.oulu.tol.sqat;
